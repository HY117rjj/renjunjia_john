...
public class MobileUtil {
	 ...
	 * @return 运营商名称
	 */
	public static String getMobileISP(String mobile){
		String returnString="";
	...
	public static void main(String[] arg){
		System.out.println(MobileUtil.getMobileISP("13999889090"));
		System.out.println(MobileUtil.getMobileISP("13418170986"));
		System.out.println(MobileUtil.getMobileISP("15392496493"));
		System.out.println(MobileUtil.getMobileISP("13399889090"));
		System.out.println(MobileUtil.getMobileISP("erot4543545"));
		System.out.println(MobileUtil.getMobileISP("erot543545"));
	}
}
