...
public class DateConverter implements Converter {
    ...
    private static final String MONTH_PATTERN_NO_ = "yyyyMMdd";
     ...
     * @return
     */
    public String doConvertToString(Date value) {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(MONTH_PATTERN_NO_);
        String result = "";
        result = simpleDateFormat.format(value);
        return result;
    }
