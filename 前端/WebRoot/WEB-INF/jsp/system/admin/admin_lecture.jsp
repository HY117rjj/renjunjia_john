        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            ...
            <!-- 
             ...
             -->
             <a class="am-btn am-btn-default" href="${pageContext.request.contextPath }/lecture/editLecture.do"><span class="am-icon-plus"></span> 新增</a>
             <!--
      ...
      <div class="am-g">
        <div class="am-u-sm-12">
          <form class="am-form">
            ...
            <div class="am-cf">
              	共 ${pd.total } 条记录
              	<div id="page" data-am-page="{pages:'${pd.totalPage }',jump:'./lecture/list.do?page=%page%'}"></div>
            </div>
          </form>
        </div>
      </div>
