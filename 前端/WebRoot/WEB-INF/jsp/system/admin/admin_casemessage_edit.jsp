...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="admin-content-body">
      ...
      <hr>
		<form id="form" method="post" class="am-form" action="./case/saveCaseMessage.do" onsubmit="submitModal();">
    		...
    		<div class="am-form-group">
		      <label for="name">任务发布人姓名</label>
		      <input type="text" class="am-form-field" id="name" name="name" value="${cw.name }" placeholder="输入任务发布人姓名" readonly="readonly">
		    </div>
    		<div class="am-form-group">
		      <label for="caseContent">案例分析任务</label>
		      <textarea id="caseContent" name="caseContent" rows="6" readonly="readonly">${cw.caseContent }</textarea>
		    </div>
		    
		    <div class="am-form-group">
		      <label for="messagerName">讨论人姓名</label>
		      <input type="text" class="am-form-field" id="messagerName" name="messagerName" value="${cw.messagerName }" placeholder="输入讨论人姓名">
		    </div>
		    <div class="am-form-group">
		      <label for="messageContent">讨论内容</label>
		      <textarea id="messageContent" name="messageContent">${cw.messageContent }</textarea>
		    </div>
		    
		    <div class="am-form-group">
		      <label for="name">讨论时间</label>
			...
			<div class="am-margin">
			  <c:if test="${user.name eq cw.messagerName}">
