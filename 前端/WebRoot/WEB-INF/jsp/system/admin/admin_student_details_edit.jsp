...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="admin-content-body">
      ...
      <hr>
		<form method="post" class="am-form" action="./student/saveStudentDetails.do">
			<input type="hidden" name="id" value="${studentDetails.id }"/>
			<input type="hidden" name="signTime" value="${studentDetails.signTime }"/>
			<input type="hidden" name="serialNumber" value="${sn }"/>
			<fieldset>
    		<legend>编辑学员明细信息</legend>
		    <div class="am-form-group">
		      <label for="idcard">学员身份证</label>
		      <input type="text" class="am-form-field" id="idcard" name="idcard" value="${studentDetails.idcard }" placeholder="" required>
		    </div>
		    <div class="am-form-group">
		      <label for="name">学员姓名</label>
		      <input type="text" class="am-form-field" id="name" name="name" value="${studentDetails.name }" placeholder="">
		    </div>
    		<div class="am-form-group">
		      <label for="courseware">课件</label>
		      <input type="text" class="am-form-field" id="courseware" name="courseware" value="${studentDetails.courseware }" placeholder="" readonly>
		    </div>
    		<div class="am-form-group">
		      <label for="signTime">签到时间</label>
		      <input type="text" class="am-form-field" id="signTime_" name="signTime_" value="${studentDetails.signTime_ }" placeholder="" readonly>
		    </div>
		    <div class="am-form-group">
		      <label for="eligibility">合格</label>
		      <input type="text" class="am-form-field" id="eligibility" name="eligibility" value="${studentDetails.eligibility }" placeholder="" readonly>
		    </div>
    		</fieldset>
