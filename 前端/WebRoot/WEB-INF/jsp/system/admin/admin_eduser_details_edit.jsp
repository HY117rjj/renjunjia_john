  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">系统管理</strong> / <small>游客明细管理</small></div>
      </div>
      <hr>
		<form method="post" class="am-form" action="./eduser/saveEduUserDetails.do">
			<input type="hidden" name="id" value="${eduserDetails.id }"/>
			<input type="hidden" name="signTime" value="${eduserDetails.signTime }"/>
			<input type="hidden" name="serialNumber" value="${sn }"/>
			<fieldset>
    		<legend>编辑游客明细信息</legend>
		    <div class="am-form-group">
		      <label for="idcard">学员身份证</label>
		      <input type="text" class="am-form-field" id="idcard" name="idcard" value="${eduserDetails.idcard }" placeholder="" required>
		    </div>
		    <div class="am-form-group">
		      <label for="name">学员姓名</label>
		      <input type="text" class="am-form-field" id="name" name="name" value="${eduserDetails.name }" placeholder="">
		    </div>
    		<div class="am-form-group">
		      <label for="courseware">课件</label>
		      <input type="text" class="am-form-field" id="courseware" name="courseware" value="${eduserDetails.courseware }" placeholder="" readonly>
		    </div>
    		<div class="am-form-group">
		      <label for="signTime">点播时间</label>
		      <input type="text" class="am-form-field" id="signTime_" name="signTime_" value="${eduserDetails.signTime_ }" placeholder="" readonly>
		    </div>
		    <div class="am-form-group">
		      <label for="complete">是否结束</label>
		      <input type="text" class="am-form-field" id="complete" name="complete" value="${eduserDetails.complete }" placeholder="" readonly>
		    </div>
    		</fieldset>
