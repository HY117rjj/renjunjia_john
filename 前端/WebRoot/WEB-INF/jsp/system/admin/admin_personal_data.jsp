  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">系统管理</strong> / <small>个人信息管理</small></div>
      </div>
      <hr>
		<form method="post" class="am-form" action="./student/savePersonalData.do">
    		...
    		<div class="am-form-group">
		      ...
		      <input type="text" class="am-form-field" id="idcard" name="idcard" value="${student.idcard }" placeholder="" required>
		    </div>
		    <div class="am-form-group">
