...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="admin-content-body">
      ...
      <hr>
		<form method="post" class="am-form" action="./eduser/saveEduUser.do">
			<input type="hidden" name="id" value="${eduser.id }"/>
			<fieldset>
    		<legend>编辑游客信息</legend>
		    <div class="am-form-group">
		      <label for="idcard">学员身份证</label>
		      <input type="text" class="am-form-field" id="idcard" name="idcard" value="${eduser.idcard }" placeholder="" required>
		    </div>
		    <div class="am-form-group">
		      <label for="name">学员姓名</label>
		      <input type="text" class="am-form-field" id="name" name="name" value="${eduser.name }" placeholder="">
		    </div>
    		<div class="am-form-group">
		      <label for="signTime_">注册时间</label>
		      <input type="text" class="am-form-field" id="signTime" name="signTime" value="${eduser.signTime }" placeholder="" readonly>
		    </div>
		    <div class="am-form-group">
		      <label for="charge">账户余额</label>
		      <input type="text" class="am-form-field" id="charge" name="charge" value="${eduser.charge }" placeholder="" readonly>
		    </div>
    		</fieldset>
