...
<html class="no-js fixed-layout">
  <head>
	...
	<script type="text/javascript">
		function delLog(id){
			var url = "${pageContext.request.contextPath }/log/removeLog.do?ajax=1&id="+id;
			$.get(url, function(json){
				if(json.statusCode==200){
					window.location.href="${pageContext.request.contextPath }/log/list.do";
				}
			},'json');
		}
		
		function addLog(){
			window.location.href="${pageContext.request.contextPath }/log/editLog.do";
		}
		
		function editLog(id){
			window.location.href="${pageContext.request.contextPath }/log/editLog.do?id="+id;
		}
  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">系统管理</strong> / <small>日志文件记录</small></div>
      </div>

      <hr>
<p><span class="am-icon-file-word-o am-icon-lg" style="font-size: 1200%; padding-left: 20px;"></span> <span style="font-size: 1600%;">X文件</span></p> 
      <div class="am-g">
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <th class="table-type am-hide-sm-only" style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">操作内容</th>
              ...
              <c:forEach items="${pd.rows }" var="pd">
              	<tr>
	            	<td>${pd.id }</td>
	                <td><a href="function:void(0);">${pd.name }</a></td>
            ...
            <div class="am-cf">
              	共 ${pd.total } 条记录
              	<div id="page" data-am-page="{pages:'${pd.totalPage }',jump:'./log/listLogFile.do?page=%page%'}"></div>
            </div>
          </form>
        </div>
      </div>
