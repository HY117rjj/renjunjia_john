...
<html class="no-js fixed-layout">
  <head>
	...
	<script type="text/javascript">
		function delCoursewareMessage(id){
			var url = "${pageContext.request.contextPath }/courseware/removeCoursewareMessage.do?ajax=1&id="+id;
			$.get(url, function(json){
				if(json.statusCode==200){
					window.location.href="${pageContext.request.contextPath }/courseware/listMessage.do";
				}
			},'json');
		}
		
		function addCoursewareMessage(){
			window.location.href="${pageContext.request.contextPath }/courseware/editCoursewareMessage.do";
		}
		
		function editCoursewareMessage(id){
			window.location.href="${pageContext.request.contextPath }/courseware/editCoursewareMessage.do?id="+id;
		}
	</script>
  </head>
<body>
        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            ...
            <!-- 
             ...
             -->
             <a class="am-btn am-btn-default" href="${pageContext.request.contextPath }/courseware/editCoursewareMessage.do"><span class="am-icon-plus"></span> 新增</a>
             <!--
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <th class="table-title am-hide-sm-only">授课题目</th>
                <th class="table-type">姓名</th>
                <th class="table-author am-hide-sm-only">留言内容</th>
                <th class="table-author am-hide-sm-only">留言时间</th>
              ...
              <c:forEach items="${pd.rows }" var="pd">
              	<tr>
	            	<td>${pd.id }</td>
	                <td class="am-hide-sm-only"><a href="function:void(0);">${pd.courseware }</a></td>
	                ...
	                <td>
	                  <div class="am-btn-toolbar">
	                    <div class="am-btn-group am-btn-group-xs">
	                      <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="${pageContext.request.contextPath }/courseware/editCoursewareMessage.do?id=${pd.id }"><span class="am-icon-pencil-square-o"></span> 编辑</a>
	                      <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="delCoursewareMessage('${pd.id }');"><span class="am-icon-trash-o"></span> 删除</button>
	                    </div>
	                  </div>
	                </td>
	          	</tr>
            ...
            <div class="am-cf">
              	共 ${pd.total } 条记录
              	<div id="page" data-am-page="{pages:'${pd.totalPage }',jump:'./courseware/listMessage.do?page=%page%'}"></div>
            </div>
          </form>
        </div>
      </div>
