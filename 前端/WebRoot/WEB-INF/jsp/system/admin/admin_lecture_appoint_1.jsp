        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            ...
            <!-- 
             ...
             -->
             <a class="am-btn am-btn-default" href="${pageContext.request.contextPath }/lecture/editLecture.do" style="visibility: visible;"><span class="am-icon-plus"></span> 新增</a>
             <!--
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <th class="table-date am-hide-sm-only">课程题目</th>
              ...
              <c:forEach items="${pd.rows }" var="pd">
              	<tr>
	                ...
	                <td class="am-hide-sm-only"><a href="./lecture/listAppointment2.do?sn=${pd.id }">${pd.title }</a></td>
	                <td>
	                  <div class="am-btn-toolbar">
	                    <div class="am-btn-group am-btn-group-xs">
	                      <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="${pageContext.request.contextPath }/lecture/listAppointment2.do?sn=${pd.id }"><span class="am-icon-pencil-square-o"></span> 查看预约人员</a>
	                      <!-- <button class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="editLecture('${pd.id }');"><span class="am-icon-pencil-square-o"></span> 编辑</button> -->
	                    </div>
	                  </div>
	                </td>
	          	</tr>
            ...
            <div class="am-cf">
              	共 ${pd.total } 条记录
              	<div id="page" data-am-page="{pages:'${pd.totalPage }',jump:'./lecture/listAppointment.do?page=%page%'}"></div>
            </div>
          </form>
        </div>
      </div>
