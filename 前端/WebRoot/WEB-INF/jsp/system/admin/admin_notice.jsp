  ...
  <head>
	...
	<script type="text/javascript">
		function delNotice(id){
			var url = "${pageContext.request.contextPath }/notice/removeNotice.do?ajax=1&id="+id;
		...
		function addNotice(){
			window.location.href="${pageContext.request.contextPath }/notice/editNotice.do";
		}
		
		function editNotice(id){
			window.location.href="${pageContext.request.contextPath }/notice/editNotice.do?id="+id;
		}
        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            ...
            <!-- 
             ...
             -->
             <a class="am-btn am-btn-default" href="${pageContext.request.contextPath }/notice/editNotice.do"><span class="am-icon-plus"></span> 新增</a>
            </div>
          </div>
        </div>
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <th class="table-type am-hide-sm-only" style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">通知内容</th>
	                ...
	                <td>
	                  <div class="am-btn-toolbar">
	                    <c:if test="${user.admin == '1' }">
		                    <div class="am-btn-group am-btn-group-xs">
		                      <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="${pageContext.request.contextPath }/notice/editNotice.do?id=${pd.id }"><span class="am-icon-pencil-square-o"></span> 编辑</a>
		                      ...
		                      <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="delNotice('${pd.id }');"><span class="am-icon-trash-o"></span> 删除</button>
		                    </div>
	                    </c:if>
            ...
            <div class="am-cf">
              	共 ${pd.total } 条记录
              	<div id="page" data-am-page="{pages:'${pd.totalPage }',jump:'./notice/list.do?page=%page%'}"></div>
            </div>
          </form>
        </div>
      </div>
