  ...
  <head>
	...
	<script type="text/javascript">
		function delCourseware(id){
			var url = "${pageContext.request.contextPath }/courseware/removeCourseware.do?ajax=1&id="+id;
			$.get(url, function(json){
				if(json.statusCode==200){
					window.location.href="${pageContext.request.contextPath }/courseware/list.do";
				}
			},'json');
		}
		
		function addCourseware(){
			window.location.href="${pageContext.request.contextPath }/courseware/editCourseware.do";
		}
		
		function editCourseware(id){
			window.location.href="${pageContext.request.contextPath }/courseware/editCourseware.do?id="+id;
		}
	</script>
  </head>
<body>
        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            ...
            <!-- 
             ...
             -->
             <a class="am-btn am-btn-default" href="${pageContext.request.contextPath }/courseware/editCourseware.do"><span class="am-icon-plus"></span> 新增</a>
             <!--
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <th class="table-date am-hide-sm-only">文件名</th>
	                  ...
	                  <div class="am-btn-toolbar">
	                    <div class="am-btn-group am-btn-group-xs">
	                      <c:if test="${user.admin == '1' }">
	                      	<a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="${pageContext.request.contextPath }/courseware/editCourseware.do?id=${pd.id }"><span class="am-icon-pencil-square-o"></span> 编辑</a>
	                      	<!-- <button class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="editCourseware('${pd.id }');"><span class="am-icon-pencil-square-o"></span> 编辑</button> -->
	                      	<button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="delCourseware('${pd.id }');"><span class="am-icon-trash-o"></span> 删除</button>
	                      </c:if>
	                      <c:if test="${user.admin ne '1' }">
	                      	<a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="${pageContext.request.contextPath }/courseware/editCourseware.do?id=${pd.id }"><span class="am-icon-pencil-square-o"></span> 查看</a>
	                      </c:if>
	                    </div>
	                  </div>
	                </td>
            ...
            <div class="am-cf">
              	共 ${pd.total } 条记录
              	<div id="page" data-am-page="{pages:'${pd.totalPage }',jump:'./courseware/list.do?page=%page%'}"></div>
            </div>
          </form>
        </div>
      </div>
