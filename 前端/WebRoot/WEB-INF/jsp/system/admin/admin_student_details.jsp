...
<html class="no-js fixed-layout">
  <head>
	...
	<script type="text/javascript">
		function delStudentDetails(id){
			var url = "${pageContext.request.contextPath }/student/removeStudentDetails.do?ajax=1&id="+id;
			$.get(url, function(json){
				if(json.statusCode==200){
					window.location.href="${pageContext.request.contextPath }/student/listDetails.do.do";
				}
			},'json');
		}
		
		function addStudentDetails(){
			window.location.href="${pageContext.request.contextPath }/student/editStudentDetails.do";
		}
		
		function editStudentDetails(id){
			window.location.href="${pageContext.request.contextPath }/student/editStudentDetails.do?id="+id;
		}
	</script>
  </head>
<body>
  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">系统管理</strong> / <small>学员明细管理</small></div>
      </div>
        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            ...
            <!-- 
              ...
              <a class="am-btn am-btn-default" href="${pageContext.request.contextPath }/student/editStudentDetails.do"><span class="am-icon-plus"></span> 新增</a>
             -->
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <th class="table-date am-hide-sm-only">签到时间</th>
              ...
              <c:forEach items="${pd.rows }" var="pd">
              	<tr>
	                ...
	                <td>
	                  <div class="am-btn-toolbar">
	                    <div class="am-btn-group am-btn-group-xs">
	                      <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="${pageContext.request.contextPath }/student/editStudentDetails.do?id=${pd.id }"><span class="am-icon-pencil-square-o"></span> 编辑</a>
	                      ...
	                      <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="delStudentDetails('${pd.id }');"><span class="am-icon-trash-o"></span> 删除</button>
	                    </div>
	                  </div>
	                </td>
	          	</tr>
            ...
            <div class="am-cf">
              	共 ${pd.total } 条记录
              	<div id="page" data-am-page="{pages:'${pd.totalPage }',jump:'./student/list.do?page=%page%&sn={sn}'}"></div>
            </div>
          </form>
        </div>
      </div>
