...
<html class="no-js fixed-layout">
  <head>
	...
	<script type="text/javascript">
		function delEduUserDetails(id){
			var url = "${pageContext.request.contextPath }/eduser/removeEduUserDetails.do?ajax=1&id="+id;
			$.get(url, function(json){
				if(json.statusCode==200){
					window.location.href="${pageContext.request.contextPath }/eduser/listDetails.do";
				}
			},'json');
		}
		
		function addEduUserDetails(){
			window.location.href="${pageContext.request.contextPath }/eduser/editEduUserDetails.do";
		}
		
		function editEduUserDetails(id){
			window.location.href="${pageContext.request.contextPath }/eduser/editEduUserDetails.do?id="+id;
		}
	</script>
  </head>
<body>
        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            ...
            <!-- 
              ...
              <a class="am-btn am-btn-default" href="${pageContext.request.contextPath }/eduser/editEduUserDetails.do"><span class="am-icon-plus"></span> 新增</a>
             -->
      ...
      <div class="am-g">
        <div class="am-u-sm-12">
          <form class="am-form">
            ...
            <div class="am-cf">
              	共 ${pd.total } 条记录
              	<div id="page" data-am-page="{pages:'${pd.totalPage }',jump:'./eduser/listDetails.do?page=%page%&sn={sn}'}"></div>
            </div>
          </form>
        </div>
      </div>
