      ...
      <hr>
		...
		<form method="post" class="am-form" action="">
    		...
    		<div class="am-form-group">
		      ...
		      <input type="text" class="am-form-field" id="title" name="title" value="${notice.title }" placeholder="" readonly>
		    </div>
		    <div class="am-form-group">
		    ...
		    <div class="am-form-group">
		      <label for="noticeTime">授课时间</label>
		      <input type="text" class="am-form-field" id="teachingTime" name="teachingTime" value="${fn:substring(notice.teachingTime, 0, 10) }" placeholder="" readonly>
		    </div>
		    <div class="am-form-group">
		      <label for="noticeTime">发布时间</label>
		      <input type="text" class="am-form-field" id="noticeTime" name="noticeTime" value="${fn:substring(notice.noticeTime, 0, 10) }" placeholder="" readonly>
		    </div>
    		<div class="am-form-group">
		      <label for="promulgator">发布者</label>
		      <input type="text" class="am-form-field" id="promulgator" name="promulgator" value="${notice.promulgator }" placeholder="" readonly>
		    </div>
    		</fieldset>
