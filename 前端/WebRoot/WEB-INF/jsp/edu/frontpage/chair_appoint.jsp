  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">预约讲座</strong> / <small>预约记录</small></div>
      </div>
	  ...
	  <div class="am-g">
        <div class="am-u-sm-12">
          <form class="am-form">
            ...
            <div class="am-cf">
              	共 ${pd.total } 条记录
              	<div id="page" data-am-page="{pages:'${pd.totalPage }',jump:'./chair/listAppointment.do?type=${type }&code=${code }&page=%page%'}"></div>
            </div>
          </form>
        </div>
      </div>	     
